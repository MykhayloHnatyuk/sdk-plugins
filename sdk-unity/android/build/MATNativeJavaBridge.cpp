...
extern "C"
{
	...
	const void initNativeCode (char* advertiserId, char* advertiserKey)
	{
		...
		jstring advertiserKeyUTF	= jni_env->NewStringUTF(advertiserKey); 
		...
		jobject obj_MobileAppTracker	= jni_env->NewObject(cls_MobileAppTracker, mid_MobileAppTracker, obj_Activity, advertiserIdUTF, advertiserKeyUTF);
		...
		jni_env->DeleteLocalRef(advertiserKeyUTF);
	...
	const void setAdvertiserIdentifier(char* advertiserIdentifier)
	{
		return;
	}
	...
	const void setDeviceId(bool enable)
	{
		return;
	}
	...
	const void setShouldAutoGenerateAdvertiserIdentifier(bool shouldAutoGenerate)
	{
		return;
	}
	...
	const void setShouldAutoGenerateVendorIdentifier(bool shouldAutoGenerate)
	{
		return;
	}
	...
	const void setVendorIdentifier(char* vendorIdentifier)
	{
		return;
	}
