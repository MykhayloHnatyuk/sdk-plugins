(function()
{
    ...
    console.log("MATPlugin.js: cordova = " + cordova);

    function MATPlugin()
    {
        console.log("MATPlugin.js: empty constructor");
    }
    ...
    if (cordova)
    {
        ...
        {
            console.log("MATPlugin.js: cordova addConstructor");
        
            if(!window.plugins)
            {
                console.log("MATPlugin.js: cordova addConstructor: create plugins");
                window.plugins = {};
            }
            
            if(!window.plugins.matPlugin)
            {
                console.log("MATPlugin.js: cordova addConstructor: create MAT plugin object start");
                console.log("MATPlugin.js: cordova addConstructor: create MAT plugin object");
                window.plugins.matPlugin = new MATPlugin();
                console.log("MATPlugin.js: cordova addConstructor: create MAT plugin object end, mat = " + window.plugins.matPlugin);
            }
        });
    }
})();